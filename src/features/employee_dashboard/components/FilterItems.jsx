const FilterItems = ({ handleFilterValue, tasksTotal, filterValue }) => {
  return (
    <div className="flex flex-wrap  md:flex-row justify-evenly items-center p-4 bg-gray-100 rounded-lg shadow-md">
      <div className="text-center">
        ...
        <button
          ...
          type="button"
          className={`px-2 py-0 text-lg font-medium text-white ${
            filterValue.new_task
              ? "bg-green-500 hover:bg-green-700"
              : "bg-gray-500 hover:bg-gray-700 "
          } rounded-lg shadow focus:outline-none`}
        >
          New Tasks
        </button>
      </div>
